...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-4 text-center">
      <div className="max-w-4xl text-white bg-">
        ...
        <button 
          ...
          className="bg-emerald-500 text-black px-8 py-3 rounded-full text-lg hover:bg-emerald-400 transition-all duration-300"
        >
          Contact Me
        </button>
      </div>
